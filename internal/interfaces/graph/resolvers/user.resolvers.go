...
import (
	autherr "blogThree/internal/auth/app"
...
func (r *mutationResolver) RefreshToken(ctx context.Context) (*model.AuthPayload, error) {
	req, ok := httpctx.Request(ctx)
	if !ok {
		return nil, autherr.NewNoRequestInContextError()
	}

	c, err := req.Cookie("refresh_token")
	if err != nil || c.Value == "" {
		return nil, autherr.NewNoRefreshTokenError()
	}
...
func (r *queryResolver) Users(ctx context.Context) ([]*model.User, error) {
	...
	return toUserModelList(dbUsers), nil
}
